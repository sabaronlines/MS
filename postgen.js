const OMDB_KEY = '684fefc5'; // Replace if needed
  ...
  function generateCombinedPost() {
    ...
    // Generate post HTML
    let postHtml = `
<script src="https://sabaronlines.github.io/MS/player.js"/><link rel="stylesheet" href="https://dhanjeerider.github.io/pj/mvt.css"><div class="backdrop"><img class="backdrop-image" src="${imdbData.Poster}" loading="lazy">
